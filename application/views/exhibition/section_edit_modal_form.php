            ...
            <fieldset>
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <textarea class="form-control" id="sec_description" name="sec_description" required="">
                                <?= $sec->description ?>
                            </textarea>
                        </div>
                    </div>
...
<script type="text/javascript">
    $('#section_edit_form').ready(function() {
        $('#sec_main_pic').fileinput({
            initialPreview: [
                "<img src='user_uploads/user_1/sec_<?= $sec->id ?>.jpg' class='file-preview-image' alt='sec_main_pic'>"
            ],
            language: 'zh-TW',
            showUpload: false,
            maxFileCount: 3,
