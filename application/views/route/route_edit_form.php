        ...
        <form id="route_edit_form" class="form-horizontal" action="routes/edit_route_action" method="post">
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input id="route_title" name="route_title" type="text" placeholder="" class="form-control input-md" required="" value="<?= $route->title; ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <textarea class="form-control" id="route_description" name="route_description"><?= $route->description; ?></textarea>
                    </div>
                </div>
...
<script type="text/javascript">
    $('#route_edit_form').ready(function() {
